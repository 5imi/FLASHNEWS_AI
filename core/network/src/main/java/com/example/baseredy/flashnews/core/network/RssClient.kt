...
object RssClient {
    ...
    private val sources = listOf(
        ...
        RssSource("CNBC",           "https://search.cnbc.com/rs/search/combinedcms/view.xml?id=10000115", "GLOBAL", "Business & Finanțe"),
        RssSource("MarketWatch",    "http://feeds.marketwatch.com/marketwatch/topstories/", "GLOBAL", "Business & Finanțe"),
        RssSource("Forbes US",      "https://www.forbes.com/real-time/feed2/",           "GLOBAL", "Business & Finanțe"),
        ...
        RssSource("Engadget",       "https://www.engadget.com/rss.xml",                  "GLOBAL", "Tehnologie"),
        ...
        RssSource("VentureBeat",    "https://venturebeat.com/feed/",                     "GLOBAL", "Tehnologie"),
        ...
        RssSource("ZDNet",          "https://www.zdnet.com/news/rss.xml",                "GLOBAL", "Tehnologie"),
        ...
        RssSource("r/Futurology",   "https://www.reddit.com/r/Futurology/top/.rss?t=day", "GLOBAL", "Tehnologie"),
        ...
        RssSource("Euractiv",       "https://www.euractiv.com/feed/",                    "GLOBAL", "Politică"),
        ...
        RssSource("ESPN",           "https://www.espn.com/espn/rss/news",                "GLOBAL", "Sport"),
        RssSource("Sky Sports",     "https://www.skysports.com/rss/12040",               "GLOBAL", "Sport"),
        RssSource("Bleacher Report", "https://bleacherreport.com/articles/feed",         "GLOBAL", "Sport"),
        RssSource("Marca English",  "https://e00-marca.uecdn.es/rss/en/football.xml",    "GLOBAL", "Sport"),
        RssSource("Goal.com",       "https://www.goal.com/feeds/en/news",                "GLOBAL", "Sport"),
        RssSource("Guardian Sport", "https://www.theguardian.com/sport/rss",             "GLOBAL", "Sport"),
        RssSource("L'Équipe",       "https://www.lequipe.fr/rss/actu_rss.xml",           "GLOBAL", "Sport"),
        ...
        RssSource("Top Gear",       "https://www.topgear.com/rss.xml",                   "GLOBAL", "Auto"),
        ...
        RssSource("NatGeo",         "https://www.nationalgeographic.com/foundation/rss/index.html", "GLOBAL", "Știință & Mediu"),
        RssSource("Live Science",   "https://www.livescience.com/home/feed/about.xml",   "GLOBAL", "Știință & Mediu"),
        ...
        RssSource("r/science",      "https://www.reddit.com/r/science/top/.rss?t=day",   "GLOBAL", "Știință & Mediu"),
        ...
        RssSource("Medical News Today", "https://www.medicalnewstoday.com/feed",         "GLOBAL", "Sănătate"),
        RssSource("WHO News",       "https://www.who.int/feeds/entity/mediacentre/news/en/rss.xml", "GLOBAL", "Sănătate"),
        RssSource("WebMD",          "https://rssfeeds.webmd.com/rss/rss.aspx?RSSSource=RSS_PUBLIC", "GLOBAL", "Sănătate"),
        RssSource("Harvard Health", "https://www.health.harvard.edu/blog/rss",           "GLOBAL", "Sănătate"),
        RssSource("NHS UK News",    "https://www.nhs.uk/news/feed/",                     "GLOBAL", "Sănătate"),
        ...
        RssSource("Inside Higher Ed", "https://www.insidehighered.com/rss/feed/news",    "GLOBAL", "Educație"),
        ...
        RssSource("r/romania",      "https://www.reddit.com/r/romania/top/.rss?t=day",   "RO", "General"),
        ...
        RssSource("AP News",        "https://apnews.com/feed",                           "GLOBAL", "General"),
        ...
        RssSource("CBS News",       "https://www.cbsnews.com/latest/rss/main",           "GLOBAL", "General"),
        RssSource("PBS NewsHour",   "https://www.pbs.org/newshour/feeds/rss/headlines",  "GLOBAL", "General"),
        RssSource("El País English", "https://feeds.elpais.com/mrss-s/pages/ep/site/elpais.com/section/inenglish/portada", "GLOBAL", "General"),
        ...
        RssSource("VOA News",        "https://www.voanews.com/api/zpqioumkee",            "GLOBAL", "General"),
        RssSource("Meduza EN",       "https://meduza.io/en/rss/all",                     "GLOBAL", "General"),
        ...
        RssSource("OCCRP",           "https://occrp.org/en/feed/articles",               "GLOBAL", "General"),

        // Israel & Orientul Mijlociu
        RssSource("Times of Israel", "https://www.timesofisrael.com/feed/",              "GLOBAL", "General"),
        RssSource("Jerusalem Post",  "https://www.jpost.com/rss/rssfeedsfrontpage.aspx",  "GLOBAL", "General"),
        RssSource("Haaretz",         "https://www.haaretz.com/cmlink/1.4603348",          "GLOBAL", "General"),
        RssSource("Al Arabiya",      "https://english.alarabiya.net/tools/rss",           "GLOBAL", "General"),
        RssSource("Gulf News",       "https://gulfnews.com/rss/world",                    "GLOBAL", "General"),
        RssSource("Arab News",       "https://www.arabnews.com/cat/1/rss.xml",            "GLOBAL", "General"),
        RssSource("The National",    "https://www.thenationalnews.com/rss",               "GLOBAL", "General"),
        ...
        RssSource("China Daily",    "https://www.chinadaily.com.cn/rss/china_rss.xml",   "GLOBAL", "General"),
        RssSource("CGTN",           "https://www.cgtn.com/subscribe/rss/news.xml",       "GLOBAL", "General"),
        ...
        RssSource("Folha de S.Paulo", "https://feeds.folha.uol.com.br/emcimadagora/rss091.xml", "GLOBAL", "General"),
        RssSource("Buenos Aires Times", "https://www.batimes.com.ar/feed",                "GLOBAL", "General"),
        RssSource("MercoPress",     "https://en.mercopress.com/rss",                     "GLOBAL", "General"),
        ...
        // SUA & Canada
        RssSource("Washington Post", "https://feeds.washingtonpost.com/rss/world",        "GLOBAL", "General"),
        RssSource("NPR News",       "https://feeds.npr.org/1001/rss.xml",                "GLOBAL", "General"),
        RssSource("CBC Canada",     "https://www.cbc.ca/cxml/rss/rss-topstories.xml",     "GLOBAL", "General"),
        ...
        RssSource("CNA Asia",       "https://www.channelnewsasia.com/api/v1/rss-outbound/rssnews/cna_news.xml", "GLOBAL", "General"),
        ...
        RssSource("Inquirer Ph",    "https://inquirer.net/feed",                         "GLOBAL", "General"),
